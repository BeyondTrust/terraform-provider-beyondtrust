...
output "integration_id" {
  ...
  value       = beyondtrust_workload_credentials_aws_integration.main.id
}

output "developer_dynamic_secret_path" {
  description = "Path to developer dynamic secret"
  value       = beyondtrust_workload_credentials_aws_dynamic_secret.developer_access.path
}

output "admin_dynamic_secret_path" {
  description = "Path to admin dynamic secret"
  value       = beyondtrust_workload_credentials_aws_dynamic_secret.admin_access.path
}
