...
- `api_url` (String) The base URL for the BeyondTrust API (e.g., https://api.workload-credentials.example.com). Can also be set via BEYONDTRUST_API_URL environment variable.
