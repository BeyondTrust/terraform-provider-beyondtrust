...
subcategory: ""
description: |-
  Manages a static secret in BeyondTrust Secrets Manager. The secret value is write-only and not stored in Terraform state. Use the ephemeral data source to read secret values.
---
